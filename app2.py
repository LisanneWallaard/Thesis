...
def user_input_features() -> pd.DataFrame:
    ...
    options_age_cat = ("18-24", "25-29", "30-34", "35-39", "40-44", "45-49", "50-54",
                        "55-59", "60-64", "65-69", "70-74", "75-79", "80 or older")
    age_cat = st.sidebar.selectbox("Age category",
                                    options=options_age_cat)
    options_bmi_cat = ("Underweight (BMI < 18.5)", "Normal weight (18.5 <= BMI < 25.0)", 
                        "Overweight (25.0 <= BMI < 30.0)", "Obese (30.0 <= BMI < +Inf)")
    bmi_cat = st.sidebar.selectbox("BMI category",
                                    options=options_bmi_cat)
    ...
    phys_act = st.sidebar.selectbox("Have you played any sports (running, biking, etc.)"
                                    " in the past month?", options=options_yes_no)
    ...
    alcohol_drink = st.sidebar.selectbox("Do you have more than 14 drinks of alcohol (men)"
                                            " or more than 7 (women) in a week?", options=options_yes_no)
    ...
    diff_walk = st.sidebar.selectbox("Do you have serious difficulty walking"
                                        " or climbing stairs?", options=options_yes_no)
